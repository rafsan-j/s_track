...
export default function ManageResourcesPage() {
  ...
  function resetDownstream(level: string) {
    if (level === "semester") { setCourses([]); setModules([]); setTopics([]); setResources([]); }
    if (level === "course") { setModules([]); setTopics([]); setResources([]); }
    if (level === "module") { setTopics([]); setResources([]); }
